...
Так, в работе~\cite{Jang2006} описан синтез красителя~\cmpd{Jang} с использованием N,N-дибутиламинобензальдегида в качестве донора с удлиненной тиофенсодержащей полиметиновой цепью и N-замещенного трицианопирролина~(\ac{tcp}) в качестве акцептора.
...
Аналогичным способом был синтезирован новый пиперидинозамещенный краситель \cmpd{benzaldehyde_thiophene_TCP.piperidine}. 
